...
import choose from "../../../public/images/choose.jpg";
                            ...
                            <div className="wpo-choose-grids clearfix">
                                <div className="grid">
                                    ...
                                    <div className="info">
                                        ...
                                        <p>Certified professionals with years of teaching experience.</p>
                                    </div>
                                </div>
                                <div className="grid">
                                    <div className="icon">
                                    ...
                                    <div className="info">
                                        ...
                                        <p>Tailored lessons to fit each student’s learning style.</p>
                                    </div>
                                </div>
                                <div className="grid">
                                    <div className="icon">
                                    ...
                                    <div className="info">
                                        <h3>One-on-One Interactive Sessions</h3>
                                        <p>Focused tutoring for better concept clarity.</p>
                                    </div>
                                </div>
                                <div className="grid">
                                    <div className="icon">
                                    ...
                                    <div className="info">
                                        <h3>Affordable & Flexible Schedules                                        </h3>
